...
public struct ColumnContentInfo<T>: Identifiable {
    ...
    public init(id: Int, type: ColumnContentType, color: @escaping (T) -> Color?, content: @escaping (T) -> String, hoverColor: ((T) -> Color)? = nil, hoverContent: ((T) -> String)? = nil) {
        self.id = id
        self.type = type
        self.color = color
    ...
    public init(id: Int, defaults: TableDefaults, type: ColumnContentType, color: ((T) -> Color?)? = nil, content: ((T) -> String)? = nil, hoverColor: ((T) -> Color)? = nil, hoverContent: ((T) -> String)? = nil) {
        self.id = id
        self.type = type
